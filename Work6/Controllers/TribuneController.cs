...
namespace Work6.Controllers
{
    public class TribuneController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            //HttpWebResponse res = HttpRequestHelper.CreateGetHttpResponse("http://eps.haid.com.cn/Portal/WebServices/HaidService.asmx/GetDimissionProcToOther?secretKey=8a90899456fd0bdd0156fd4a1db6001b&userNo=000091", null, "", null);
